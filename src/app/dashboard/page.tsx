    ...
    <div className="min-h-screen bg-black text-zinc-100">
      ...
      <main className="mx-auto max-w-4xl px-4 py-10">
        ...
        <nav className="mb-10 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
          <Link
            href="/examples"
            className="w-full max-w-xs rounded-lg border border-zinc-700 bg-zinc-900/60 px-8 py-3 text-center text-base font-semibold text-zinc-200 transition hover:border-accent/60 hover:bg-accent/10 sm:w-auto"
          >
            Examples
          </Link>
          <Link
            href="/analyze"
            className="w-full max-w-xs rounded-lg bg-accent px-8 py-3 text-center text-base font-semibold text-white transition hover:bg-accent-hover sm:w-auto"
          >
            Analyze
          </Link>
        </nav>
